...
* The output of the program should be:
    ...
    * followed by a new line
* My guide: [Python - Dígitos](https://www.lawebdelprogramador.com/foros/Python/1539716-Digitos.html), [How to check last digit of number](https://stackoverrun.com/es/q/1281502)
...
* You are not allowed to import any module
* My guide: [hex() function in Python](https://www.geeksforgeeks.org/python-hex-function/), [Python: hex() function](https://www.w3resource.com/python/built-in-function/hex.php)
...
***Example:***
```bash
dany@ubuntu:~/0x01$ cat 9-main.py
#!/usr/bin/env python3
...
* You are not allowed to import any module
* File: **[10-add.py](https://github.com/dany-eduard/holbertonschool-higher_level_programming/blob/main/0x01-python-if_else_loops_functions/10-add.py)**  
  
***Example:***
```bash
dany@ubuntu:~/0x01$ cat 10-main.py
#!/usr/bin/env python3
...
________________________________________________
### 11. a ^ b
_Write a function that computes a to the power of b and return the value._
* Prototype: ````def pow(a, b):````
* Returns the value of ````a ^ b````
* You are not allowed to import any module
* File: **[11-pow.py](https://github.com/dany-eduard/holbertonschool-higher_level_programming/blob/main/0x01-python-if_else_loops_functions/11-pow.py)**  
  
***Example:***
```bash
dany@ubuntu:~/0x01$ cat 11-main.py
#!/usr/bin/env python3
...
________________________________________________
### 12. Fizz Buzz
_Write a function that prints the numbers from 1 to 100 separated by a space._
* For multiples of three print ````Fizz```` instead of the number and for multiples of five print ````Buzz````.
* For numbers which are multiples of both three and five print ````FizzBuzz````.
* Prototype: ````def fizzbuzz():````
* Each element should be followed by a space
* You are not allowed to import any module
* File: **[12-fizzbuzz.py](https://github.com/dany-eduard/holbertonschool-higher_level_programming/blob/main/0x01-python-if_else_loops_functions/12-fizzbuzz.py)**  
  
***Example:***
```bash
dany@ubuntu:~/0x01$ cat 12-main.py
#!/usr/bin/env python3
...
dany@ubuntu:~/0x01$ ./12-main.py | cat -e
...
* File: **[13-insert_number.c](https://github.com/dany-eduard/holbertonschool-higher_level_programming/blob/main/0x01-python-if_else_loops_functions/13-insert_number.c), [lists.h](https://github.com/dany-eduard/holbertonschool-higher_level_programming/blob/main/0x01-python-if_else_loops_functions/lists.h)**  
...
_Write a program that prints the ASCII alphabet, in reverse order, alternating lowercase and uppercase (``z`` in lowercase and Y in uppercase) , not followed by a new line._
* You can only use one ````print```` function with string format
* You can only use one loop in your code
* You are not allowed to store characters in a variable
* You are not allowed to import any module
* File: **[100-print_tebahpla.py](https://github.com/dany-eduard/holbertonschool-higher_level_programming/blob/main/0x01-python-if_else_loops_functions/100-print_tebahpla.py)**  
  
***Example:***
```bash
dany@ubuntu:~/0x01$ ./100-print_tebahpla.py
zYxWvUtSrQpOnMlKjIhGfEdCbAdany@ubuntu:~/0x01$
```  
  
________________________________________________
### 15. Remove at position ***#advanced***
_Write a function that creates a copy of the string, removing the character at the position ``n`` (not the Python way, the “C array index”)._
* Prototype: ````def remove_char_at(str, n):````
* You are not allowed to import any module
* My guide: [¿Como remover un carácter de una cadena por posición? Python](https://es.stackoverflow.com/questions/323160/como-remover-un-car%C3%A1cter-de-una-cadena-por-posici%C3%B3n-python)
* File: **[101-remove_char_at.py](https://github.com/dany-eduard/holbertonschool-higher_level_programming/blob/main/0x01-python-if_else_loops_functions/101-remove_char_at.py)**  
  
***Example:***
```bash
dany@ubuntu:~/0x01$ cat 101-main.py
#!/usr/bin/env python3
...
_Write the Python function_ ````def magic_calculation(a, b, c):```` _that does exactly the same as the following Python bytecode:_
* File: **[102-magic_calculation.py](https://github.com/dany-eduard/holbertonschool-higher_level_programming/blob/main/0x01-python-if_else_loops_functions/102-magic_calculation.py)**
